...
class Sandbox:
    ...
    def simulate_step(self):
        ...
        if self.season == 0 and np.random.rand() < self.config["spring_bird_spawn_chance"]:
            ...
            if len(spawn_positions) > 0:
                ny, nx = spawn_positions[np.random.randint(len(spawn_positions))]
                if self.layers["Birds"][ny, nx] == 0:  # 确保目标格子没有鸟
    ...
    def render(self):
        ...
        while running:
            ...
            screen.blit(font.render("PES-her", True, (0, 0, 0)), (625, toolbar_y + 15))
            screen.blit(font.render("PES-ins", True, (0, 0, 0)), (725, toolbar_y + 15))
...
if __name__ == "__main__":
    sandbox = Sandbox(config_file="config_better13_sys.json")
    sandbox.render()
