...
class Sandbox:
    def __init__(self, config_file="config.json"):
        ...
        # Initialize bird ages with default values
    ...
    def render(self):
        ...
        while running:
            ...
            delete_button = pygame.Rect(520, toolbar_y + 10, 80, 30)
            ...
            screen.blit(font.render("Delete", True, (0, 0, 0)), (525, toolbar_y + 15))
...
if __name__ == "__main__":
    sandbox = Sandbox(config_file="config_bird7_add.json")
    sandbox.render()
